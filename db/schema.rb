...
ActiveRecord::Schema.define(version: 2019_03_27_071429) do
  ...
  create_table "drub", id: :integer, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  end
